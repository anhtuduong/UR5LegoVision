...
ACTION_LIST = [
    ...
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    # Command.move_to(f'Move above {model_1}', pose=[0.19, 0.48, 1.0, 0.3894183, 0.921061, 0, 0]),
    # Command.move_to(f'Move down to {model_1}', pose=[0.19, 0.48, 0.91, 0.3894183, 0.921061, 0, 0]),
    ...
    # Command.move_to(f'Pick up {model_1}', pose=[0.19, 0.48, 1.1, 0.3894183, 0.921061, 0, 0]),
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    ...
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    # Command.move_to(f'Move above {model_2}', pose=[0.26, 0.63, 1.0, -0.4794255, 0.8775826, 0, 0]),
    # Command.move_to(f'Move down to {model_2}', pose=[0.26, 0.63, 0.91, -0.4794255, 0.8775826, 0, 0]),
    ...
    # Command.move_to(f'Pick up {model_2}', pose=[0.26, 0.63, 1.1, -0.4794255, 0.8775826, 0, 0]),
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    ...
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    # Command.move_to(f'Move above {model_3}', pose=[0.0623, 0.51, 1.0, 0, 180, 90]),
    # Command.move_gripper(f'Grasp {model_3}', diameter=75),
    # Command.move_to(f'Move down to {model_3}', pose=[0.063, 0.51, 0.91, 0, 180, 90]),
    # Command.move_gripper(f'Grasp {model_3}', diameter=70),
    ...
    # Command.move_to(f'Pick up {model_3}', pose=[0.063, 0.51, 1.1, 0, 180, 90]),
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.1, 0, 180, 0]),
    # Command.move_to(f'Move to rotate position', pose=[0.456, 0.27, 1.0, 0, 270, 0]),
    ...
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    # Command.move_to(f'Move above {model_4}', pose=[0.07, 0.65, 1.0, 0, 180, -47.5098709]),
    # Command.move_gripper(f'Open gripper', diameter=75),
    # Command.move_to(f'Move down to {model_4}', pose=[0.07, 0.65, 0.91, 0, 180, -47.5098709]),
    ...
    # Command.move_to(f'Pick up {model_4}', pose=[0.07, 0.65, 1.1, 0, 180, -47.5098709]),
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    # Command.move_to(f'Move to rotate position', pose=[0.44, 0.55, 0.95, 0, 270, 0]),
    ...
    # Command.move_gripper(f'Release {model_4}', diameter=75),
    # Command.move_to(f'Move above rotate position', pose=[0.44, 0.55, 1.2, 0, 270, 0]),
    # Command.move_to(f'Rotate', pose=[0.415, 0.545, 1.1, 0, 180, -90]),
    # Command.move_to(f'Move to rotated lego', pose=[0.415, 0.545, 0.99, 0, 180, -90]),
    # Command.move_gripper(f'Grasp {model_4}', diameter=35),
    # Command.attach_models(f'Attach {model_4} to gripper', model_name_1=model_4, link_name_1=lego_link, model_name_2=robot_model, link_name_2=gripper_link),
    # Command.detach_models(f'Detach {model_4} from table', model_name_1=model_4, link_name_1=lego_link, model_name_2='tavolo', link_name_2='link'),
    # Command.move_to(f'Move above rotate position', pose=[0.415, 0.545, 1.1, 0, 180, 0]),
    # Command.move_to('Move above the place position', pose=[0.6, 0.7, 1.0, 0, 180, 0]),
    # Command.move_to('Move down to the place position', pose=[0.6, 0.7, 0.9483, 0, 180, 0]),
    # Command.attach_models(f'Attach {model_4} to table', model_name_1=model_4, link_name_1=lego_link, model_name_2='tavolo', link_name_2='link'),
    # Command.detach_models(f'Detach {model_4} from gripper', model_name_1=model_4, link_name_1=lego_link, model_name_2=robot_model, link_name_2=gripper_link),
    # Command.move_gripper(f'Release {model_4}', diameter=60),
    # Command.move_to(f'Move above {model_4}', pose=[0.6, 0.7, 0.9483, 0, 180, 0]),

    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
    # Command.move_to(f'Move above {model_5}', pose=[0.19, 0.71, 1.0, 0.6816388, 0.7316889, 0, 0]),
    # Command.move_to(f'Move down to {model_5}', pose=[0.19, 0.71, 0.91, 0.6816388, 0.7316889, 0, 0]),
    ...
    # Command.move_to(f'Pick up {model_5}', pose=[0.19, 0.71, 1.1, 0.6816388, 0.7316889, 0, 0]),
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0, 180, 0]),
