...
ACTION_LIST = [
    ...
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0.0, 1.0, 0.0, 0.0]),
    # Command.move_to(f'Move above {model_4}', pose=[0.09, 0.69, 1.0, -0.9320391, 0.3623578, 0, 0]),
    # Command.move_to(f'Move down to {model_4}', pose=[0.09, 0.69, 0.91, -0.9320391, 0.3623578, 0, 0]),
    ...
    # Command.move_to(f'Pick up {model_4}', pose=[0.09, 0.69, 1.1, -0.9320391, 0.3623578, 0, 0]),
    # Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0.0, 1.0, 0.0, 0.0]),
    # # Command.move_to('Move above the place position', pose=[0.6, 0.7, 1.05, 0.0, 1.0, 0.0, 0.0]),
    # # Command.move_to(f'Move side {model_4}', pose=[0.6, 0.7, 1.05, -0.7071068, 0, 0, 0.7071068]),
