...
ACTION_LIST = [
    ...
    Command.move_to(f'Pick up {model_3}', pose=[0.26, 0.63, 1.1, 0.7071055, -0.7071081, 9e-7, 9e-7]),
    Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0.0, 1.0, 0.0, 0.0]),
    ...
    Command.move_to(f'Move to middle', pose=[0.456, 0.619, 1.2, 0.0, 1.0, 0.0, 0.0]),
    Command.move_to('Move above the place position', pose=[0.6, 0.7, 1.0, 0.0, 1.0, 0.0, 0.0]),
